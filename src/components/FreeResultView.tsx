...
<div className="flex flex-col items-center justify-center gap-3 pt-2">
  <div className="flex items-center gap-1.5 text-[11px] text-stone-500 font-medium">
    ...
    <span>Others are sharing their readings right now</span>
  </div>

  <button
    id="open-share-card-btn"
    onClick={onOpenShareModal}
    className="animate-gentle-bounce w-full px-6 py-3.5 rounded-xl bg-gradient-to-r from-rose-600 to-rose-700 hover:from-rose-700 hover:to-rose-800 text-white text-sm font-bold transition-all flex items-center justify-center gap-2.5 shadow-md shadow-rose-600/20 active:scale-[0.99] cursor-pointer"
  >
